...
def rewrite_nav_params(context, **kwargs):
    ...
    param_substitutions_nav = {
        ...
        'bt_navigator.ros__parameters.default_nav_through_poses_bt_xml': os.path.join(mst110cr_navigation_dir, 'params', 'mst110cr_navigate_through_poses_w_replanning_and_recovery.xml'),
...
def rewrite_ekf_params(context, **kwargs):
    ...
    configured_ekf_params=RewrittenYaml(
        source_file=mst110cr_ekf_yaml_file,
        root_key=common_prefix_val,
...
def process_xacro(context, *args, **kwargs):
    ...
    mst110cr_xacro_file = os.path.join(mst110cr_description_dir, "urdf", "mst110cr.xacro")
    with open(mst110cr_xacro_file, 'r') as file:
        filedata = file.read()
    filedata = filedata.replace('<xacro:property name="tf_prefix" value="mst110cr_tf"/>', f'<xacro:property name="tf_prefix" value="{tf_prefix_val}"/>')
...
def generate_nodes(context, *args, **kwargs):
    ...
    mst110cr_standby_rviz_file = os.path.join(mst110cr_unity_dir, "rviz", "mst110cr_standby.rviz")
...
def generate_launch_description():
    ...
    common_prefix_arg = DeclareLaunchArgument('common_prefix',default_value='mst110cr')
